...
function attachControls() {
    if (!elements.keywordInput || !elements.companySelector || !elements.roleSelector || !elements.postedSelect || !elements.sortSelect || !elements.jobTypeButtons || !elements.clearFilters)
        return;
